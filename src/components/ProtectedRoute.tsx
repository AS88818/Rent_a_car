      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center max-w-sm">
          ...
          <p className="text-gray-600 mb-1">
            {requiredRoles ? `This page requires ${requiredRoles.join(' or ')} access.` : 'Your account role could not be verified.'}
          </p>
          <p className="text-sm text-gray-500 mb-6">Your current role: <span className="font-medium">{userRole || 'Unknown'}</span></p>
          <button
