      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full animate-in fade-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Delete Maintenance Log</h2>
          </div>
          <button
            onClick={handleClose}
            disabled={loading}
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            <p className="text-gray-700">You are about to delete this maintenance log:</p>
            <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 text-sm text-gray-900 space-y-1">
              <p className="font-medium">{log.service_date} — {log.mileage.toLocaleString()} km</p>
              <p className="text-gray-600 line-clamp-2">{log.work_done}</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                disabled={loading}
                rows={3}
                placeholder="e.g., Duplicate entry, Entered in error, Wrong vehicle..."
