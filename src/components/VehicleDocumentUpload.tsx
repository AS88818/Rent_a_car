...
export function VehicleDocumentUpload({ vehicleId, onDocumentUploaded }: VehicleDocumentUploadProps) {
  ...
  const loadDocuments = async () => {
    ...
    try {
      setLoading(true);
      const data = await vehicleDocumentService.getDocuments(vehicleId);
      setDocuments(data || []);
    } catch (error: any) {
  ...
  const handleUpload = async () => {
    ...
    try {
      setUploading(true);
      await vehicleDocumentService.uploadDocument(vehicleId, selectedFile, documentType, notes);
          ...
          {selectedFile && (
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => { setSelectedFile(null); setNotes(''); }}
